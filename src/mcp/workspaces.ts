...
export function registerWorkspaceTools(server: McpServer) {
	server.registerTool(
		...
		workspace.listWorkspacesHandler as any
	);
	...
	workspace.getWorkspaceHandler as any
	);
	...
	workspace.createWorkspaceHandler as any
	);
	...
	workspace.updateWorkspaceHandler as any
	);
	...
	server.registerTool(
		...
		workspace.deleteWorkspaceHandler as any
	);
}
