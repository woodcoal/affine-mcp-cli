 ...
 */
export async function listWorkspaceTreeHandler(parsed: {
  workspaceId?: string;
  depth?: number;
}) {
  const workspaceId = parsed.workspaceId || getDefaultWorkspaceId();
 ...
 */
export async function listBacklinksHandler(parsed: {
  workspaceId?: string;
  docId: string;
}) {
  const workspaceId = parsed.workspaceId || getDefaultWorkspaceId();
 ...
 */
export async function listChildrenHandler(parsed: {
  workspaceId?: string;
  docId: string;
}) {
  const workspaceId = parsed.workspaceId || getDefaultWorkspaceId();
